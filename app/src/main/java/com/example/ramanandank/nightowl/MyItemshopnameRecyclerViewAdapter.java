...
import com.example.ramanandank.nightowl.ItemshopnameFragment.OnListFragmentInteractionListener;
...
public class MyItemshopnameRecyclerViewAdapter extends RecyclerView.Adapter<MyItemshopnameRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemshopnameRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
